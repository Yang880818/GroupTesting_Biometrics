...
### For K = 1
Result_1 <- read.csv("./results/Boot/LogTrans_3Bio_WholeBlood_Seed.boot=1000_K=1_0.99_0.9_2023-06-27.csv", header = T)
Result_1
...
#########################################################################################################################################
### For K = 2
Result_2 <- read.csv("./results/Boot/LogTrans_3Bio_WholeBlood_Seed.boot=1000_K=2_0.99_0.9_2023-06-27.csv", header = T)
Result_2
## Mean of Diseased and Non-diseased
...
#########################################################################################################################################
## For K = 5
Result_5 <- read.csv("./results/Boot/LogTrans_3Bio_WholeBlood_Seed.boot=1000_K=5_0.99_0.9_2023-06-27.csv", header = T)
Result_5
## Mean of Diseased and Non-diseased
...
lines(aa, sort(1 - ROC.curve_2), type = "l", col = "blue",  lty = "longdash", lwd = 2)
lines(aa, sort(1 - ROC.curve_5), type = "l", col = "deeppink",  lty = "dotdash", lwd = 2)
#abline(0, 1, col = "red", lwd = 1, lty = 1)
